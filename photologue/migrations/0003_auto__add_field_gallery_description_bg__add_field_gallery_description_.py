...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Gallery.description_bg'
        db.add_column('photologue_gallery', 'description_bg',
        ...
        # Adding field 'Photo.caption_bg'
        db.add_column('photologue_photo', 'caption_bg',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Gallery.description_bg'
        db.delete_column('photologue_gallery', 'description_bg')

        # Deleting field 'Gallery.description_en'
        db.delete_column('photologue_gallery', 'description_en')

        # Deleting field 'Photo.caption_bg'
        db.delete_column('photologue_photo', 'caption_bg')
    ...
    models = {
        ...
        'photologue.photo': {
            ...
            'caption': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'caption_bg': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
