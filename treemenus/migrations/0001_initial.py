...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('treemenus_menuitem', (
            ...
            ('caption_bg', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('caption_en', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
    ...
    models = {
        ...
        'treemenus.menuitem': {
            ...
            'caption_bg': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'caption_en': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
