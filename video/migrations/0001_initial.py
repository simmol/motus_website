...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('video_video', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='video_created_by', null=True, to=orm['auth.User'])),
            ('edited_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='video_edited_by', null=True, to=orm['auth.User'])),
