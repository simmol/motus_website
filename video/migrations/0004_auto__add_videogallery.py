...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('video_videogallery', (
            ...
            ('title_bg', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True, blank=True)),
        ...
        db.send_create_signal('video', ['VideoGallery'])

        # Adding M2M table for field videos on 'VideoGallery'
        db.create_table('video_videogallery_videos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('videogallery', models.ForeignKey(orm['video.videogallery'], null=False)),
            ('video', models.ForeignKey(orm['video.video'], null=False))
        ))
        db.create_unique('video_videogallery_videos', ['videogallery_id', 'video_id'])


    def backwards(self, orm):
        # Deleting model 'VideoGallery'
        db.delete_table('video_videogallery')

        # Removing M2M table for field videos on 'VideoGallery'
        db.delete_table('video_videogallery_videos')
    ...
    models = {
        ...
        'video.video': {
            ...
            'embedUrl': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'video.videogallery': {
            'Meta': {'ordering': "['-date_added']", 'object_name': 'VideoGallery'},
            ...
            'title_bg': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'title_en': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'videos': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'galleries'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['video.Video']"})
        }
    }
