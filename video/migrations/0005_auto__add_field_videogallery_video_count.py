...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoGallery.video_count'
        db.add_column('video_videogallery', 'video_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoGallery.video_count'
        db.delete_column('video_videogallery', 'video_count')
