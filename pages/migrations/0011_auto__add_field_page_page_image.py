...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pages_page', 'page_image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('pages_page', 'page_image')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'page_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
