...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pages_page', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='category', null=True, to=orm['pages.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.category'
        db.delete_column('pages_page', 'category_id')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'category'", 'null': 'True', 'to': "orm['pages.Category']"}),
            'content_type': ('django.db.models.fields.CharField', [], {'default': "'SYS'", 'max_length': '3'}),
