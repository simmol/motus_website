...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.event_start'
        db.add_column('pages_page', 'event_start',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.event_end'
        db.add_column('pages_page', 'event_end',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.event_start'
        db.delete_column('pages_page', 'event_start')

        # Deleting field 'Page.event_end'
        db.delete_column('pages_page', 'event_end')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'event_end': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'event_start': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
