...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pages_page', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='created_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Page.edited_by'
        db.add_column('pages_page', 'edited_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='edited_by', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Page.edited'
        db.add_column('pages_page', 'edited',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('pages_page', 'created_by_id')

        # Deleting field 'Page.edited_by'
        db.delete_column('pages_page', 'edited_by_id')

        # Deleting field 'Page.edited'
        db.delete_column('pages_page', 'edited')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'created_by'", 'null': 'True', 'to': "orm['auth.User']"}),
            'edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'edited_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'edited_by'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
