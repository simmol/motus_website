...
DATABASES = {
    'default': {
        ...
        'USER': 'newproject_user',                      # Not used with sqlite3.
        'PASSWORD': 'wslzG!PNbU4c6lzmNTPPcyHpVPvpTf',                  # Not used with sqlite3.
...
SECRET_KEY = '^,P&n;{P1)vg1")5gji~C3#Ed/#m?9|Y1-UuU%uCL\H;^-dEpQ'
